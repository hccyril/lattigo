...
// ============================ 【中文文件说明】 ============================
// 本文件实现 RLWE 密钥生成器，负责生成以下密钥：
//
// 1. 私钥 (SecretKey): 解密密钥，从三元分布采样 s ∈ {-1, 0, 1}^N
// 2. 公钥 (PublicKey): 加密密钥，pk = (-a·s + e, a)
// 3. 重线性化密钥 (RelinearizationKey): 乘法后降密文度数，加密 s²
// 4. Galois 密钥 (GaloisKey): 旋转和共轭操作，加密 σ_k(s)
// 5. 评估密钥 (EvaluationKey): 通用密钥切换，加密目标多项式
// =========================================================================
